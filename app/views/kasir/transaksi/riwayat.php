                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($data['penjualan'] as $row) : ?>
                                        <tr>
                                            ...
                                            <td width="20%">
                                                <a href="<?= BASEURL; ?>/laporan/penjualandetail/<?= $row['id_p'] ?>" class="btn btn-info modalRiwayat" data-toggle="modal" data-target="#modal-riwayat" data-id="<?= $row['id_p'] ?>"><i class="fas fa-file-alt"></i> Detail</a>
                                                <a href="<?= BASEURL; ?>/transaksi/cetakresi/<?= $row['id_p'] ?>" target="_blank" class="btn btn-success"><i class="fa fa-print"></i> Resi</a>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
                                    <?php endforeach; ?>
